...
use App\Model\TipoProcesso;
use App\Model\CourtType;
use App\Model\Tribunal;
...
class TipoTribunalController extends Controller {
    ...
    public function index()
    {
        ...
        return view('admin.configuracoes.tipo-tribunal.court_type');
    }
    ...
    public function create() {
        ...
        return response()->json([
                    'html' => view('admin.configuracoes.tipo-tribunal.caset_type_create')->render()
        ]);
    }
    ...
    public function edit($id) {
        ...
        return response()->json([
                    'html' => view('admin.configuracoes.tipo-tribunal.court_type_edit', $data)->render()
        ]);
    }
    ...
    public function destroy($id) {
        $count = 0;
        $count += Processo::where('court_type', $id)->count();
        $count += Tribunal::where('court_type_id', $id)->count();
