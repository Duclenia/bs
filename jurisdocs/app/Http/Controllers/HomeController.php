...
class HomeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $data['total_agenda'] = Agenda::whereIn('activo', ['OPEN', 'TO FORWARD'])->count();

        $data['total_agenda_hoje'] = Agenda::whereIn('activo', ['OPEN', 'TO FORWARD'])
            ->where('data', date('Y-m-d'))
            ->count();

        $data['total_agenda_futura'] = Agenda::whereIn('activo', ['OPEN', 'TO FORWARD'])
            ->where('data', '>', date('Y-m-d'))
            ->count();
        ...
        $getAppointment = DB::table('agenda AS a')
            ...
            ->whereIn('a.activo', ['OPEN', 'TO FORWARD'])
