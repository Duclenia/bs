            ...
            <form id="add_client" name="add_client" role="form" method="POST" autocomplete="nope"
                ...
                <div class="x_content">
                    ...
                    <div class="col-md-4 col-sm-12 col-xs-12 form-group f_name" style="display: none">
                        ...
                        <input type="text" name="f_name" class="form-control text-uppercase" id="f_name" autocomplete="off"
                               data-msg-required="Por favor, insere o nome do cliente">
                    </div>
                    ...
                    <div class="col-md-4 col-sm-12 col-xs-12 form-group l_name" style="display: none">
                        ...
                        <input type="text" name="l_name" class="form-control text-uppercase" value="{{old('l_name')}}" id="l_name"  autocomplete="off"
                    ...
                    <div class="col-md-4 col-sm-12 col-xs-12 form-group instituicao" style="display: none">
                        ...
                        <input type="text" name="instituicao" class="form-control text-uppercase" value="{{old('instituicao')}}" id="instituicao" autocomplete="off"
                    ...
                    <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                        ...
                        <input type="text" name="nif" class="form-control text-uppercase" value="{{old('nif')}}" id="nif" autocomplete="off"
                    ...
                    <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                        ...
                        <input type="email" name="email" class="form-control email" value="{{old('email')}}" id="email" autocomplete="off">
                    </div>
                    ...
                    <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                        ...
                        <input type="tel" name="mobile" class="form-control" value="{{old('mobile')}}" id="mobile" required autocomplete="off">

                    </div>

                    <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                        <label for="alternate_no">Telefone</label>
                        <input type="tel" name="alternate_no" class="form-control" value="{{old('alternate_no')}}" id="alternate_no" autocomplete="off">
                    </div>

                    <div class="country col-md-4 col-sm-12 col-xs-12 form-group">
                        <label for="country">{{__('Country')}} <span class="text-danger">*</span></label>
                        <select class="form-control select-change country-select2" required=""
                    ...
                    <div class="col-md-8 col-sm-12 col-xs-12 form-group">
                        ...
                        <input type="text" name="address" class="form-control" value="{{old('address')}}" id="address" required autocomplete="off">
                    </div>
                    ...
                    <div id="change_court_div" class="hidden">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                ...
                                <input type="radio" name="type" id="test7" value="multiple"/>&nbsp;&nbsp;V&aacute;rios advogados
                            </div>
                        </div>
                                    ...
                                    <div class="row border-addmore"
                                        ...
                                        <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                            <label for="firstname">{{__('First Name')}} <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" id="firstname" name="firstname"
                                                   data-rule-required="true" data-msg-required="Por favor, insere o primeiro nome."
                                                   class="form-control">
                                        </div>
                                        ...
                                        <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                            ...
                                            <input type="text" id="middlename" name="middlename"
                                                   data-rule-required="true" data-msg-required="Por favor, insere o nome do meio."
                                                   class="form-control">
                                        </div>
                                        ...
                                        <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                            <label for="lastname">{{__('Last Name')}} <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" id="lastname" name="lastname"
                                                   data-rule-required="true" data-msg-required="Por favor, insere o sobrenome."
                                                   class="form-control">
                                        </div>
                                        <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                            <label for="mobile_client">Telefone <span
                                        ...
                                        <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                            <label for="advocate_name">Nome do Advogado <span class="text-danger">*</span></label>
