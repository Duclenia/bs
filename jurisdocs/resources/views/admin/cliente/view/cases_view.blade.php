...
@section('title','Cliente Processos')
@section('content')
    <div class="page-title">
        <div class="title_left">
            <h4>Nome do(a) cliente : {{$name}} </h4>
        </div>
...
@endsection
@push('js')
    <script src="{{asset('assets/js/cliente/client-case-datatable.js')}}"></script>
@endpush
