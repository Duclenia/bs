            ...
            <div class="x_panel">
                <div class="right-part-bg-all">
                    <div class="ctzn-usrs">
                        ...
                        <h1 class="invoice-center">Factura </h1>
                        <div class="row">
                            <div class="col-xs-12">

                                <div class="invoice-title">
                                    <h3 class="pull-right">Factura N&ordm;: INV-000015</h3>
                                </div>
                                ...
                                <div class="row">
                                        ...
                                        <address>
                                            <div>
                                                ...
                                                <div class="discount_text">
                                                    ...
                                                    <br> <strong>Endere&ccedil;o: </strong>Rajkot ,Rajkot

                                                    <br> <strong>Telefone: </strong> 0789456132
                                                </div>
                                            </div>
                                        </address>
                                    </div>
                                    <div class="col-xs-6 text-right">
                                        <address>
                                            <strong>Data da factura:</strong> 01-01-2019<br>

                                            <strong>Data de vencimento da factura:</strong> 30-01-2019<br>
                                            <strong> Tipo de Imposto:</strong> Out Of Tax<br>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-condensed">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center" width="10%"><strong>Quantidade</strong></td>
