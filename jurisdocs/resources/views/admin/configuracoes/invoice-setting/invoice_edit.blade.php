...
@section('title','Configuração de factura')
@section('content')
    <div class="page-title">
        <div class="title_left">
            <h3>Configura&ccedil;&atilde;o de factura</h3>
        </div>
                    ...
                    <div class="x_content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                <label for="invoice_prefex">Prefixo da factura </label>
                                <input type="text" class="form-control" id="invoice_prefex"
                                       name="invoice_prefex" value="{{!empty($setting->prefix)?$setting->prefix:''}}">
                            </div>

                            <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                <label for="invoice_number">N&ordm; da pr&oacute;xima factura </label>
                                <input type="text" placeholder="" class="form-control" id="last_number" readonly=""
                                       name="last_number" value="{{ ($setting->invoice_no + 1 )}}">
                            </div>

                            <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                <label for="forment">Formato de factura </label><br>

                                <input type="radio" name="forment" id="test3" 
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                <label for="predefine_clientnote">{{__('Predefine Client Note')}}</label>
                                <textarea rows="7" placeholder="" class="form-control" name="predefine_client"
                                          id="predefine_client">{{$setting->client_note ?? ""}}</textarea>
                            </div>

                            <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                <label for="term_condition">Termos e condi&ccedil;&otilde;es predefinidos</label>
                                <textarea rows="7" class="form-control" id="predefine_term_note"
