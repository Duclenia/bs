        ...
        <form action="{{ route('case-status.store') }}" method="POST" id="tagForm" name="tagForm">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel2">Adicionar estado do processo</h4>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                            <label for="case_status">Estado do processo <span class="text-danger">*</span></label>
...
<script src="{{asset('assets/js/configuracoes/case-statue-validation.js')}}"></script>