    ...
    <div class="modal-dialog" role="document">
         <form action=" {{route('tax.update',$tax->id)}}" method="POST" id="tagForm" name="tagForm" >
            ...
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel2">Editar Imposto</h4>
            </div>
          ...
          <div class="col-md-12 col-sm-12 col-xs-12 form-group">
              <label for="case_type">{{__('Name')}} <span class="text-danger">*</span> </label>
          ...
          <div class="col-md-12 col-sm-12 col-xs-12 form-group">
              ...
              <input type="text" class="form-control" id="per" name="per" value="{{$tax->per ?? ''}}">
          </div>

          <div class="col-md-12 col-sm-12 col-xs-12 form-group">
              <label for="note">Observa&ccedil;&atilde;o </label>
