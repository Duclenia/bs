...
@section('content')
    <div class="">
        ...
        @component('component.modal_heading',
             [
             'page_title' => 'Tribunal',
             'action'=>route("tribunal.create"),
             'model_title'=>'Adicionar Tribunal',
             'modal_id'=>'#addtag',
              'permission' => auth()->user()->can('court_add')
             ] )
            Status
        @endcomponent
...
@push('js')
    <script src="{{asset('assets/js/configuracoes/cort-datatable.js')}}"></script>
