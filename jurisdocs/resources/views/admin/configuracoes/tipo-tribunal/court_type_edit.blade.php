    ...
    <div class="modal-dialog" role="document">
        <form action="{{route('court-type.update',$court->id)}}" method="POST" id="tagForm" name="tagForm" >
          ...
          <div class="col-md-12 col-sm-12 col-xs-12 form-group">
              ...
              <input type="text" name="court_name" placeholder="" class="form-control" value="{{ $court->court_type_name ?? '' }}" id="court_name">
          </div>
        </div>
  ...
  <script src="{{asset('assets/js/configuracoes/cort-type-validation.js')}}"></script>
