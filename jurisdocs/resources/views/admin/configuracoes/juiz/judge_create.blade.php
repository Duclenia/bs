<div class="modal fade" id="addtag" role="dialog" aria-labelledby="addcategory" aria-hidden="true">
    ...
    <div class="modal-dialog" role="document">
        <form action="{{ route('juiz.store') }}" method="POST" id="tagForm" name="tagForm">
            @csrf()
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel2">Adicionar Juiz</h4>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                            ...
                            <input type="text" class="form-control" id="judge_name" name="judge_name" autocomplete="off" required="">
                        </div>
                    </div>
