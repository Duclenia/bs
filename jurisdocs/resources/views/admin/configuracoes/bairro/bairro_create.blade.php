<div class="modal fade" id="addtag" role="dialog" aria-labelledby="addcategory" aria-hidden="true">
    ...
    <div class="modal-dialog" role="document">
        <form action="{{ route('bairro.store') }}" method="POST" id="tagForm" name="tagForm">
            @csrf()
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel2">Adicionar Bairro</h4>
                </div>
...
<script src="{{asset('assets/js/configuracoes/bairro-validation.js')}}"></script>
