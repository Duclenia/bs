...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
                <form action="{{ route('horario.store') }}" method="POST" id="tagForm" name="tagForm">
                    @csrf()
                    <div class="x_content">
                    ...
                    success: function(response) {
                        ...
                        if (response.success && response.data) {
                            ...
                            if (response.data.day_off == 1) {
                                ...
                                enableWorkInputs();
                            } else if (response.data.day_off == 0) {
                                $('#day_off_nao').prop('checked', true);
                                disableWorkInputs();
                            } else {
                                // day_off é nulo - desabilitar inputs
                                $('input[name="day_off"]').prop('checked', false);
                                disableWorkInputs();
                            }

                            // Converter array de breaks para string
                            ...
                            $('#breaks').val('');
                            $('input[name="day_off"]').prop('checked', false);
                            enableWorkInputs(); // Habilitar para novo cadastro
                        }
                    },
                    error: function() {
