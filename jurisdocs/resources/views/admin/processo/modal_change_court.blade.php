    ...
    <div class="modal-body">
        ...
        <div class="row change-m-bottom">
            <div class="col-md-10 col-md-offset-1">
                <div class="contct-info">
                    <div class="form-group">
                        <label class="discount_text"> Tipo de juiz<span class="text-danger">*</span></label>
                        <select class="form-control select2 selct2-width-100" id="judge_type" name="judge_type">
                            <option value="">Seleccionar tipo de juiz</option>
        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <div class="contct-info">
                    <div class="form-group">
                        <label class="discount_text"> Nome do juiz</label>
...
<script src="{{asset('assets/js/processo/change-model-validation.js')}}"></script>