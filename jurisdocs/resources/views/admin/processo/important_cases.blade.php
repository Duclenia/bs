                ...
                <div class="row">
                   ...
                   <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                    ...
                    <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                     ...
                     <button type="submit" id="search" disabled="disabled"  class="btn btn-success"> <i class="fa fa-search"></i> Pesquisar</button>
                   </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <li role="presentation" class="{{(Request::is('admin/processo'))?'active':''}} ">
                  <a   href="{{url('admin/processo')}}">Processos correntes</a>
                </li>
...
@push('js')
   <script src="{{asset('assets/js/processo/case-important-datatable.js')}}"></script>
@endpush
