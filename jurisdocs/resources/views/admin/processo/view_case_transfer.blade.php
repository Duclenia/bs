            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                        ...
                        <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                            <li role="presentation"
                                class="@if(Request::segment(2)=='case-running')active @ else @endif"><a
                                        href="{{route('processo.show',$case_id)}}">Detalhes</a>
                            </li>
                            <li role="presentation"
                    ...
                    <table id="case_transfer_list" class="table row-border">
                        ...
                        <tr>
                            <th width="5%">No</th>
                            <th width="25%">No de registo</th>
                            <th width="15%">Data de Transfer&ecirc;ncia</th>
...
@endsection
@push('js')
    <script src="{{asset('assets/js/processo/case-transfer-datatable.js')}}"></script>
@endpush
