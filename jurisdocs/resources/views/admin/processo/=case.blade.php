        ...
        <div class="page-title">
            ...
            <div class="title_right">
                <div class="form-group pull-right top_search">
                    ...
                    <a href="{{ route('case.index') }}" class="btn btn-primary">Adicionar processo</a>
                    ...
                    <div class="x_content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                ...
                                <br>
                                <button class="btn btn-primary case-margin-top-3" type="button" >Limpar</button>
                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <div class="col-md-2 col-sm-12 col-xs-12 form-group">
                            <h4><a href="">Processos correntes</a></h4>
                        </div>
                        <div class="col-md-2 col-sm-12 col-xs-12 form-group">
                            <h4><a href="">Processos importantes</a></h4>
                        </div>
                        <div class="col-md-2 col-sm-12 col-xs-12 form-group">
                            <h4><a href="">No Board Cases</a></h4>
                        </div>
                        <div class="col-md-2 col-sm-12 col-xs-12 form-group">
                            <h4><a href="">Processos arquivados</a></h4>
                        </div>
                        <table id="datatable" class="table">
                            <thead>
                            <tr>
                                <th>No</th>
                                <th>Cliente & Detalhes do processo</th>
                                <th>Detalhes do Tribunal</th>
