...
<form method="post" id="form_case_imp" name="form_case_imp">
            ...
            <div class="col-md-12">
                <div class="contct-info">
                    <div class="form-group">
                        <label class="discount_text">Prioridade do processo <span class="text-danger">*</span></label>
...
<script src="{{asset('assets/js/processo/change-priority-validation.js')}}"></script>
