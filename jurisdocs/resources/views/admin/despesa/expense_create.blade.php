                                ...
                                <div class="col-md-12 form-group">
                                    ...
                                    <select class="form-control select2" name="vendor_id" id="vendor_id"
                                        ...
                                        @foreach($vendors as $vendor)
                                            <option
                                                value="{{$vendor->id}}">@if($vendor->company_name!=''){{$vendor->company_name}}@elseif($vendor->nome!=''){{$vendor->nome.' '.$vendor->sobrenome}}@else
                                                    'N/A' @endif</option>
                                        @endforeach
                                    </select><br><br>
                                    <label for="billed_from">Dados do fornecedor </label><br>
