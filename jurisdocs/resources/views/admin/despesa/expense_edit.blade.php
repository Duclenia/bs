        ...
        <div class="page-title">
            ...
            <div class="title_right">
                <div class="form-group pull-right top_search">
                    ...
                    <a href="{{ url('admin/expense') }}" class="btn btn-primary">{{__('Back')}}</a>
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="row">
                                <div class="col-md-12 form-group">
                                    ...
                                    <label for="vendor">{{__('Vendor')}} <span class="text-danger">*</span></label>
                                    <select class="form-control select2" name="vendor_id" id="vendor_id"
                                        ...
                                        @foreach($vendors as $vendor)
                                            <option
                                                    value="{{$vendor->id}}" {{($vendor->id == $expense->fornecedor_id)?'selected':''}}>@if($vendor->company_name!=''){{$vendor->company_name}}@elseif($vendor->nome!=''){{$vendor->nome.' '.$vendor->sobrenome}}@else
                                                    'N/A' @endif</option>
                                        @endforeach
                                    </select><br><br>
                        ...
                        <div class="col-sm-12">
                            <div class="table-responsive">
                                <table class="table tableInv" id="purchaseInvoice" data-repeater-list="group">
                                    ...
                                    <tr class="tbl_header_color dynamicRows">
                                        ...
                                        <th width="" class="text-center">{{__('Description')}}
                                        </th>
                                    ...
                                    <tbody>
                                    @if(! empty($expense->itensDespesa))
                                        @foreach($expense->itensDespesa as $item)
                                                ...
                                                <th width="" class="text-center">
                                                    ...
                                                    <select class="form-control sel categories_ids"
                                                        ...
                                                        @foreach($category as $cat)
                                                            <option value="{{ $cat->id }}"
                                                                    @if(isset($item) && $item->category_id == $cat->id ) selected @endif>{{ $cat->nome }}</option>
                                                        @endforeach
                                                    </select>
                                                <th width="" class="text-center">
                                                    <input type="text" class="form-control" id="description"
                                                           name="description" value="{{ $item->descricao  }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 text-center">
                                    <a href="{{ url('admin/expense') }}" class="btn btn-danger"> {{__('Cancel')}}</a>
...
@push('js')
    <script src="{{asset('assets/js/despesa/expense-validation.js')}}"></script>
