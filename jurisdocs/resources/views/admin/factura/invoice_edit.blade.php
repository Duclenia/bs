    ...
    <div class="page-title">
        ...
        <div class="title_right">
            <div class="form-group pull-right top_search">
                ...
                <a href="{{ url('admin/factura') }}" class="btn btn-primary">{{__('Back')}}</a>
                ...
                <div class="row invoice-info">
                    <div class="col-sm-4">
                        ...
                        <div class="row">
                            <div class="col-md-12 form-group">
                                <label for="vendor">{{__('Client')}} <span class="text-danger">*</span></label>
                                <select class="form-control client_id" name="client_id" id="client_id"
                                    ...
                                    <option
                                        value="{{ $list->id}}" {{($list->id == $invoice->cliente_id)?'selected':''}}>{{ $list->id. ' - '.$list->FullName}}</option>
                                    @endforeach
                                </select>
                    ...
                    <div class="col-sm-4 form-horizontal form-label-left">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-5 col-sm-3 col-xs-12">Factura No: <span
                                    class="text-danger">*</span></label>
                            <div class="col-md-7 col-sm-9 col-xs-12">
                                <div class="invoice-margin-top"><b>{{ $invoice->factura_no ?? ''}}</b></div>
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="control-label col-md-5 col-sm-3 col-xs-12">{{__('Invoice Date')}}: <span
                                    class="text-danger">*</span></label>
                            <div class="col-md-7 col-sm-9 col-xs-12">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-5 col-sm-3 col-xs-12">Data de vencimento da factura: <span
                                    class="text-danger">*</span></label>
                            <div class="col-md-7 col-sm-9 col-xs-12">
                ...
                <div class="row">
                    <div class="col-sm-12">
                            ...
                            <table class="table tableInv" id="purchaseInvoice" data-repeater-list="invoice_items">
                                <thead class="thead-inverse">
                                    <tr class="tbl_header_color dynamicRows">
                                        ...
                                        <th class="hide with_tax" width="15%" class="text-center">Imposto (%)</th>
                                        <th class="hide with_tax" width="10%" class="text-center">Imposto </th>
                                    ...
                                    <tr data-repeater-item>
                                        ...
                                        <th width="30%" class="text-center">
                                            <select class="form-control sel services" name="services" id="services"
                                                ...
                                                <option MyServiceAmount="0.00" value="">Seleccionar Servi&ccedil;o</option>
                                                @foreach($service_lists as $service)
                                                <option MyServiceAmount="{{ $service->valor }}"
                                                        @if(isset($i) && $i->servico_id == $service->id ) selected
                                                        @endif
                                                        value="{{ $service->id }}">{{ $service->nome }}</option>
                                                @endforeach
                                            </select>
                                        </th>
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                <div>
                                    <p class="text-danger">* {{__('Mandatory fields')}}</p>
                                    <ul/>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="pull-right col-md-5">
                                <table class="table row-border dataTable no-footer" id="tab_logic_total">
                                    <tr>
                                        <th class="text-left expence-p-top-18 ">{{__('SubTotal')}}</th>
                                    ...
                                    <tr>
                                        <th class="text-center">
                                            <select id="tax" class="tax" name="tax" class="form-control">
                                                <option MyTax="" value="">Seleccionar Imposto</option>
                                                @foreach($tax as $t)
                                                <option MyTax="{{ $t->per }}"
                                                        value="{{ $t->id }}"
                                ...
                                <table class="table row-border dataTable no-footer" id="tab_logic_total">
                                    ...
                                    <tr>
                                        <th class="text-left expence-p-top-18">{{__('Total')}}</th>
                                        <td class="text-center total-width-expence">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 text-center">
                                <a href="{{ url('admin/factura') }}" class="btn btn-danger">{{__('Cancel')}}</a>
...
<script src="{{asset('assets/js/factura/invoice-validation.js')}}"></script>
