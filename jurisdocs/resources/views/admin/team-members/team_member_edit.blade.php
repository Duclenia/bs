                                            ...
                                            <div class="file-tab">
                                                @if ($adm->pessoasingular->pessoa->foto != '')
                                                    <img id="crop_image"
                                                        ...
                                                        width='100px' height='100px' class="crop_image_img">
                                                    <br>
                                                ...
                                                <label class="btn btn-link btn-file">
                                                    <span class="fa fa-upload text-center font-15"><span
                                                            class="set-profile-picture"> &nbsp; Definir foto de
                                                            perfil</span>
                                                    </span>
                            ...
                            <div class="col-md-8 col-sm-12 col-xs-12">
                                <div class="row form-group">
                                    <div class="col-md-6 col-sm-12 col-xs-12">
                                        ...
                                        <input type="text" id="f_name" name="f_name" class="form-control"
                                            value="{{ old('f_name', $adm->pessoasingular->nome ?? null) }}" required
                                            autocomplete="off">
                                    </div>
                                ...
                                <div class="row form-group">
                                    <div class="col-md-6 col-sm-12 col-xs-12">
                                        ...
                                        <input type="text" id="nome_pai" name="nome_pai" class="form-control"
                                            value="{{ old('nome_pai', $adm->pessoasingular->nome_pai) }}"
                                            autocomplete="off">
                                    </div>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" id="ddn" name="ddn" class="form-control"
                                            readonly
                                    ...
                                    <div class="row form-group">
                                        <div class="col-md-6">
                                            <label for="Role">Fun&ccedil;&atilde;o <span
                                                    class="text-danger">*</span></label>
                                            <select id="role" name="role" required class="form-control select2">
                                                <option value=""> Seleccionar</option>
                                                @foreach ($roles as $roal)
                                                    <option value="{{ $roal->id }}"
                                                        {{ $adm->utilizador->funcoes->contains($roal->id) ? 'selected=""' : '' }}>
                                                        {{ $roal->nome }}</option>
                                                @endforeach
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-6">
                                        <a class="btn btn-warning"
                                            href="{{ route('horario-advogado.create', $adm->utilizador->id) }}">{{ __('Configurar horario de atendimentos') }}</a>
                                    </div>
                                </div>
                            ...
                            <div class="form-group pull-right">
                                <div class="col-md-12 col-sm-6 col-xs-12">
                                    ...
                                    <a class="btn btn-danger"
                                        href="{{ url('admin/client_user') }}">{{ __('Cancel') }}</a>
