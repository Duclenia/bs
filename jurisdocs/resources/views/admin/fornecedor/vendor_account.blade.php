                    ...
                    <div class="x_content">
                        <div class="" role="tabpanel" data-example-id="togglable-tabs">
                            <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                <li role="presentation" class="{{ request()->is('admin/fornecedor/*') ? 'active' : '' }}"><a
                                            href="{{route('fornecedor.show',$client->id)}}">Detalhes do fornecedor</a>
                                </li>
