...
<table border="1" cellpadding="0" cellspacing="0" width="100%"
                ...
                <tr>
                        ...
                        <table border="0" cellpadding="5" cellspacing="0" width="100%">
                            <tr>
                                <td width="96%" style="font-size: 12px;">
                                    <b> Factura de:</b>
                                    <br>
                                    {{$advocate_client->primeiro_nome." ".$advocate_client->nome_meio." ".$advocate_client->sobrenome }}
                                    <br>
                                        <strong>Endere&ccedil;o:- </strong>{{$advocate_client->endereco}}
                                    {{$city}}
                                    <br>
                    ...
                    <td width="36%" valign="top">
                        <table width="100%" border="0" cellpadding="4" cellspacing="0"
                            ...
                            <tr>
                                <td style="border-bottom:0px solid black;"><strong>Data limite de pagto:</strong></td>
            ...
            <table width="100%" border="0" cellpadding="2" cellspacing="0">
                <tr>
                    ...
                    <td width="25%" align="left"
                        style="border-right: 1px solid #000;border-bottom: 1px solid #000;font-size: 9pt;"><strong>Servi&ccedil;o</strong>
                    </td>
                    <td width="50%" align="left"
                        style="border-right: 1px solid #000;border-bottom: 1px solid #000;font-size: 9pt;"><strong>Descri&ccedil;&atilde;o</strong>
                    </td>

                    <td width="9%" align="center"
                        style="border-right: 1px solid #000;border-bottom: 1px solid #000;font-size: 9pt;"><strong>Quantidade</strong>
                    </td>
    ...
    <tr>
        <td>
            <table border="0" cellpadding="5" cellspacing="0" width="100%">
                <tr>
                    <td style="font-size: 11px;"><strong style="font-size:13px;">Termos & Condi&ccedil;&otilde;es :</strong> <br/>
                        <ul>
                            @if(!empty($myTerm))
                                @foreach($myTerm as $t)
                                    <li> {{ $t}}</li>
