...
<div class="container">
    ...
    <table width="100%" border="0" style="border-style:none">
        <tr>
            ...
            <td class="remove-border heading2" width="50%" style="text-align: right;">Total de processos
                : {{ $totalCaseCount }}</td>
        </tr>
            ...
            @foreach($case_dashbord as $court)
                ...
                <table width="100%" style="margin-top:12px; border-style: solid;">
                    <tr>
                        ...
                        <td class="heading3" width="20%" style="text-align:center !important;"><b>Processos </b></td>
