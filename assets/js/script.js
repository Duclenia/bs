...
if(jQuery().dataTable) {
    ...
    $.extend( true, $.fn.dataTable.defaults, {
        oLanguage: {
            ...
            "sInfo": 'Mostrando de' + " _START_ " + 'até' + " _END_ " + 'de' + " _TOTAL_ " + 'registo(s)',
            "sInfoEmpty": 'Mostrando' + " 0 " + 'de' + " 0 " + 'até' + " 0 " + 'registos',
            "sInfoFiltered": "(" + 'filtrado' + " " + 'de' + " _MAX_ " + 'registos no total' + ")",
            "sLengthMenu": 'Mostrar' + " _MENU_ " + 'registos',
            "sSearch": 'Procurar',
            "sZeroRecords": 'Não foram encontrados resultados',
            oPaginate: {
                sNext: '<span class="pagination-default"></span><span class="pagination-fa">Seguinte</span>',
...
if(jQuery().validate) {
    ...
    }, 'Por favor, insere um nº de telefone válido.');
