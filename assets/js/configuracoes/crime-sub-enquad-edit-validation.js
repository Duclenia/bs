...
var check_subEnq_crime_exist = $('#common_check_exist').val();
    ...
    init: function () {
        ...
        $("#tagForm").validate({
            ...
            messages: {
                ...
                crimEnquad: 'Por favor, seleccione o enquadramento do crime',
                
                crimeSubEnquad: {
                    required: "Por favor, insere o sub-enquadramento do crime",
                    remote: "Este sub-enquadramento do crime já existe."
                }
            },
